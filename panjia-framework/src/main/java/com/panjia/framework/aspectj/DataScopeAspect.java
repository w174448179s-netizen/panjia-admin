package com.panjia.framework.aspectj;
...
import com.panjia.framework.security.context.PermissionContextHolder;
...
public class DataScopeAspect
{
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String userAlias, String deptAlias, String userField, String deptField, String permission)
    {
        ...
        for (SysRole role : user.getRoles())
        {
            ...
            {
                sqlString.append(StringUtils.format(" OR {}.{} IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} OR (',' || ancestors || ',') LIKE '%,' || CAST({} AS TEXT) || ',%' )", deptAlias, deptField, user.getDeptId(), user.getDeptId()));
            }
