package com.panjia.common.utils.file;
...
import com.panjia.common.exception.file.FileNameLengthLimitExceededException;
import com.panjia.common.exception.file.FileSizeLimitExceededException;
import com.panjia.common.exception.file.InvalidExtensionException;
import com.panjia.common.utils.DateUtils;
import com.panjia.common.utils.StringUtils;
import com.panjia.common.utils.uuid.IdUtils;
import com.panjia.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = PanJiaConfig.getProfile();
    ...
    {
        int dirLastIndex = PanJiaConfig.getProfile().length() + 1;
